...
namespace Wings.Framework.Common.Service
{
    ...
    public static class OSSService
    {
        ...
        /// 上传的bucket
        /// </summary>
        public static string bucketName { get; } = "zdhd-shop";
        /// <summary>
        /// 服务器上传后返回的文件地址前缀
        /// </summary>
        public static string url { get; } = @"http://zdhd-shop.oss-cn-beijing.aliyuncs.com";
        ...
        public static PutObjectResult uploadBitmap(string bucketName, string key, Bitmap bitmap)
        {
            ...
            var rtn = OSSService.uploadFile( key, ms);
            ms.Close();
            bitmap.Dispose();
            return rtn;
        ...
        /// <returns></returns>
        public static PutObjectResult uploadFile(string key,  Stream stream)
        {
            try
            {
